...
sim: command line: ../simplesim-3.0/sim-outorder -ruu:size 16 go.alpha 50 9 2stone9.in 

sim: simulation started @ Wed Oct  7 22:08:40 2009, options follow:
...
sim_elapsed_time                594 # total simulation time in seconds
sim_inst_rate           918875.2912 # simulation speed (in insts/sec)
sim_total_insn            696342042 # total number of instructions executed
sim_total_refs            270205972 # total number of loads and stores executed
sim_total_loads           216505558 # total number of loads executed
sim_total_stores       53700414.0000 # total number of stores executed
sim_total_branches         92006973 # total number of branches executed
sim_cycle                 413102940 # total simulation time in cycles
...
IFQ_count                1025177255 # cumulative IFQ occupancy
IFQ_fcount                230361673 # cumulative IFQ full count
ifq_occupancy                2.4817 # avg IFQ occupancy (insn's)
...
RUU_count                3688145351 # cumulative RUU occupancy
RUU_fcount                111885303 # cumulative RUU full count
...
LSQ_count                1442467422 # cumulative LSQ occupancy
LSQ_fcount                 40279608 # cumulative LSQ full count
...
sim_slip                 5167478850 # total number of slip cycles
avg_sim_slip                 9.4675 # the average slip between issue and retirement
bpred_bimod.lookups        99408230 # total number of bpred lookups
bpred_bimod.updates        73904299 # total number of updates
bpred_bimod.addr_hits      57810859 # total number of address-predicted hits
bpred_bimod.dir_hits       58474255 # total number of direction-predicted hits (includes addr-hits)
bpred_bimod.misses         15430044 # total number of misses
bpred_bimod.jr_hits         6012056 # total number of address-predicted hits for JR's
...
bpred_bimod.retstack_pushes      7850558 # total number of address pushed onto ret-addr stack
bpred_bimod.retstack_pops      8846841 # total number of address popped off of ret-addr stack
bpred_bimod.used_ras.PP      6139559 # total number of RAS predictions used
bpred_bimod.ras_hits.PP      5947715 # total number of RAS hits
bpred_bimod.ras_rate.PP    0.9688 # RAS prediction rate (i.e., RAS hits/used RAS)
il1.accesses              762969689 # total number of accesses
il1.hits                  747299271 # total number of hits
il1.misses                 15670418 # total number of misses
il1.replacements           15669906 # total number of replacements
...
dl1.accesses              228443979 # total number of accesses
dl1.hits                  226896499 # total number of hits
dl1.misses                  1547480 # total number of misses
dl1.replacements            1546968 # total number of replacements
dl1.writebacks               705755 # total number of writebacks
...
ul2.accesses               17923653 # total number of accesses
ul2.hits                   17769532 # total number of hits
ul2.misses                   154121 # total number of misses
ul2.replacements             150025 # total number of replacements
ul2.writebacks                17455 # total number of writebacks
...
itlb.accesses             762969689 # total number of accesses
itlb.hits                 762968544 # total number of hits
...
dtlb.accesses             229975794 # total number of accesses
dtlb.hits                 229975112 # total number of hits
dtlb.misses                     682 # total number of misses
dtlb.replacements               560 # total number of replacements
...
mem.ptab_misses             1938147 # total first level page table misses
mem.ptab_accesses        3857285349 # total page table accesses
