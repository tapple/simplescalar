...
void
_fatal(const char *file, const char *func, int line, char *fmt, ...)   /*modified by Meng from "char" to "const char"*/
...
void
_panic(const char *file, const char *func, int line, char *fmt, ...)  /*modified by Meng from "char" to "const char"*/
__attribute__ ((noreturn));
#else /* !__GNUC__ */
void
panic(char *fmt, ...);   
...
void
_warn(const char *file, const char *func, int line, char *fmt, ...);   /*modified by Meng from "char" to "const char"*/
#else /* !__GNUC__ */
void
warn(char *fmt, ...);   
#endif /* !__GNUC__ */
...
void
_debug(const char *file, const char *func, int line, char *fmt, ...);   /*modified by Meng from "char" to "const char"*/
#else /* !__GNUC__ */
void
debug(char *fmt, ...);   
#endif /* !__GNUC__ */
